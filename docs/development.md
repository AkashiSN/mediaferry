...
4. **A の画面確認。** **B-2 は 2026-08-23 に画面から踏んで合格**（「同じ構成でやり直す」で
   題材を作り、設定 › 詳しい情報 › 使っていないファイルから 71.2 GB を削除。確認
   ダイアログにファイル名が出て、行と実体が一緒に消え、孤立も増えなかった）。
   **A（写真から派生物を消す）はまだ画面から押していない。**
